...
async function main() {
  ...
  const categories = await Promise.all([
    ...
    prisma.category.create({ data: { name: 'Coffe' } }),
    prisma.category.create({ data: { name: 'Iced Drint' } }),
  ...
  await Promise.all([
    prisma.size_product.create({ data: { name: 'Small', costs: 0, productId: products[0].id } }),
    prisma.size_product.create({ data: { name: 'Medium', costs: 5000, productId: products[0].id } }),
    prisma.size_product.create({ data: { name: 'Large', costs: 10000, productId: products[0].id } }),
    prisma.size_product.create({ data: { name: 'Small', costs: 0, productId: products[6].id } }),
    prisma.size_product.create({ data: { name: 'Medium', costs: 5000, productId: products[6].id } }),
    prisma.size_product.create({ data: { name: 'Large', costs: 10000, productId: products[6].id } }),
    prisma.size_product.create({ data: { name: 'Small', costs: 0, productId: products[10].id } }),
    prisma.size_product.create({ data: { name: 'Medium', costs: 5000, productId: products[10].id } }),
    prisma.size_product.create({ data: { name: 'Large', costs: 10000, productId: products[10].id } }),
    prisma.size_product.create({ data: { name: 'Regular', costs: 0, productId: products[35].id } }),
    prisma.size_product.create({ data: { name: 'Large', costs: 5000, productId: products[36].id } }),
  ]);
  ...
  await Promise.all([
    prisma.status_transaction.create({ data: { status: 'complete', transactionId: transactions[0].id } }),
    prisma.status_transaction.create({ data: { status: 'pending', transactionId: transactions[1].id } }),
    prisma.status_transaction.create({ data: { status: 'complete', transactionId: transactions[2].id } }),
    prisma.status_transaction.create({ data: { status: 'cancel', transactionId: transactions[3].id } }),
    prisma.status_transaction.create({ data : { status: 'complete', transactionId: transactions[4].id } }),
]);
...
prisma.payment_method.create({ data: { name: 'BCA', image: 'https://logo.clearbit.com/bca.co.id', transactionId: transactions[0].id } }),
prisma.payment_method.create({ data: { name: 'Mandiri', image: 'https://logo.clearbit.com/mandiri.co.id', transactionId: transactions[1].id } }),
prisma.payment_method.create({ data: { name: 'OVO', image: 'https://logo.clearbit.com/ovo.id', transactionId: transactions[2].id } }),
prisma.payment_method.create({ data: { name: 'Dana', image: 'https://logo.clearbit.com/dana.id', transactionId: transactions[3].id } }),
prisma.payment_method.create({ data: { name: 'COD', image: null, transactionId: transactions[4].id } }),
]);
console.log('Created payment methods');
// Create Transaction Items
await Promise.all([
prisma.transaction_item.create({ data: { quantity: 1, subtotal: 10500000, transactionId: transactions[0].id } }),
prisma.transaction_item.create({ data: { quantity: 2, subtotal: 810000, transactionId: transactions[1].id } }),
prisma.transaction_item.create({ data: { quantity: 3, subtotal: 120000, transactionId: transactions[2].id } }),
prisma.transaction_item.create({ data: { quantity: 1, subtotal: 255000, transactionId: transactions[3].id } }),
prisma.transaction_item.create({ data: { quantity: 2, subtotal: 507000, transactionId: transactions[4].id } }),
]);
